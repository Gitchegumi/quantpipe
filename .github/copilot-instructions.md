...
- Python 3.13 + Rich (existing), itertools (stdlib), concurrent.futures (via existing parallel.py) (024-parallel-param-sweep)
...
- Python 3.11+ + `pandas`, `numpy`, `structlog` (Project Standard) (027-cti-metrics-progression)
- JSON configuration files (read-only CTI presets) (027-cti-metrics-progression)
